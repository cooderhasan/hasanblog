                ...
                return (
                    <div className="flex flex-wrap gap-2">
                        {['E-ticaret', 'SEO', 'Pazarlama', 'Sosyal Medya', 'Girişimcilik', 'Yazılım', 'Tasarım'].map(tag => (
                            <Link key={tag} href={`/?q=${tag}`} className="bg-gray-100 text-gray-600 text-xs px-2 py-1 hover:bg-green-600 hover:text-white transition-colors">
                                {tag}
                            </Link>
                        ))}
                    </div>
    ...
    return (
        <aside className="w-full space-y-8">
            ...
            <div className="bg-white shadow-sm border border-gray-100 p-6">
                ...
                <form action="/" className="flex flex-col gap-2">
                    <input
                        ...
                        className="w-full border border-gray-300 px-4 py-2 focus:outline-none focus:border-green-600 text-sm"
                    />
                    <button type="submit" className="w-full bg-orange-500 text-white font-bold py-2 hover:bg-orange-600 transition-colors">
                        Ara
                    </button>
                </form>
            </div>
            ...
            <div className="bg-white shadow-sm border border-gray-100 p-6 text-center">
                ...
                <Link href="/hakkimda" className="inline-block bg-blue-600 text-white font-bold py-2 px-6 hover:bg-blue-700 transition-colors mb-6">
                    Okumaya Devam Et
                </Link>
                ...
                <div className="border-t border-gray-100 pt-4">
                    ...
                    <div className="flex justify-center gap-4">
                        <a href="#" className="bg-green-500 text-white p-2 hover:bg-green-600 transition-colors">
                        ...
                        <a href="#" className="bg-blue-600 text-white p-2 hover:bg-blue-700 transition-colors">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" /></svg>
                        </a>
                        <a href="#" className="bg-pink-600 text-white p-2 hover:bg-pink-700 transition-colors">
                ...
                <div className="space-y-4">
                    {mostCommentedPosts.map((post, index) => (
                        <Link key={post.slug} href={`/${post.slug}`} className="flex gap-4 group items-center">
                            <div className="relative w-10 h-10 shrink-0 bg-red-100 flex items-center justify-center text-red-600 font-bold text-sm">
                                {index + 1}
                            </div>
                            <div>
